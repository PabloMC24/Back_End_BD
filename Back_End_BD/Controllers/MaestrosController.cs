...
namespace Back_End_BD.Controllers
{
    public class MaestrosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Matricula,Nombres,Apellidos,Correo,Edad")] Maestros maestros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Matricula,Nombres,Apellidos,Correo,Edad")] Maestros maestros)
        {
            if (ModelState.IsValid)
            {
